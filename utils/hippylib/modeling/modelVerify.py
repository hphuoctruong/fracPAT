...
def modelVerifyGradient(model, m0, is_quadratic=False, misfit_only=False, verbose=True, eps=None):
    """
    ...
    if verbose:
        modelVerifyPlotErrors(is_quadratic, eps, err_grad)
...
def modelVerifyPlotErrors(is_quadratic, eps, err_grad, err_H=None):
    try:
